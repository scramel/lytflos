...
<template>
  <section id="section-history">
    <h1 id="history" :name="name">{{ name }}</h1>
    <hr />
    <p>La historia de <span class="style-lytflos">Lytflos</span> se divide en tres partes:</p>
    <ul>
      <li>
        <p>
      ...
      <li>
        <p>
          <b>Día de la Expiación</b> (Día 0): El día en que una sombra conocido como La Silueta
          apareció y destruyó todo a su paso. La veracidad de la historia es discutida en la
          actualidad, pero la mayoría está de acuerdo en que algo arrasó con el mundo.
        </p>
      </li>
      <li>
        <p>
          <b>Años Posteriores</b> (Día 0 ~ Presente): abarca eventos como la supervivencia de los
          folia, la Era de Conquista, y la fundación de <span class="style-triadia">Triadia</span>.
        </p>
      </li>
    </ul>
    <h2 id="former-years">~ Años Anteriores</h2>
    <p>
    ...
    <p>
      Una guerra estaba siendo librada en este tiempo, y no hay mención alguna de la existencia del
      esencia. La cultura estaba inclinada a lo urbano, tanto como para pensar que había una
      preocupación por el estado del medio ambiente, y su tecnología, especialmente electrónica,
      estaba muy por encima de lo conocido en el presente.
    </p>
    <h2 id="day-0">~ Día 0</h2>
    <p>
      ...
      explosión de luz tricolor visible por el mundo entero.
    </p>
    <p>
    ...
    <p>
      ...
      glifos, con los que podían mutar el medio ambiente y ajustarla a sus necesidades.
    </p>
    <p>
      Cada talento fue necesario para sobrevivir, y por ello las comunidades existentes empezaron a
      cambiar. Las ramas similares tuvieron una tendencia a reunirse, mientras que los diferentes a
      separarse. Aparentemente existió una gran desconfianza, producto de una cadena de
      malentendidos, donde cada rama creía que los desastres que sucedían eran culpa de la
      incompetencia de los demás, e incluso hubo sospechas de abuso del poder de los anillos
      septenarios. Con el tiempo, ciudades fueron formándose, cada una exclusiva para cada rama: los
      alados alzaron Angelonia (ahora Ftéryon), los caudados levantaron Rérecros (entonces llamado
      Dúacos), y los florecidos se quedaron con Dassódils.
    </p>
    <h3 id="third-millenium">- Tercer milenio</h3>
    <p>
    ...
    <h4 id="age-of-conquest">2626: Era de Conquista</h4>
    <p>
    ...
    <p>
      Relatos aseguran que la reunión se convirtió en una discusión de niños, cada representante
      asegurando que su gente fueron la razón por la que los folia siguen vivos, pero eventualmente
      escalando a argumentos cada vez más mundanos y hasta estúpidos. Arthe fue el menos
      colaborativo de ellos, siendo incluso quien sugirió demostrar competencia a través de una
      guerra territorial.
    </p>
    <p>
      Nevhea estuvo en desacuerdo, pero Iricontes accedió, dando lugar a una mayoría. Las reglas de
      la guerra fueron definidas en poco tiempo: cada zona perteneciente a una rama debe ser
      conquistada por una de las otras mediante la fuerza. Los soldados que pierdan su crisalismo
      deben retirarse de inmediato, y si dos gobiernos se encuentran en un enfrentamiento, el
      tercero no tiene permitido intervenir en el mismo hasta que se consiga un resultado, sea una
      derrota absoluta, o una rendición.
    </p>
    <p>
    ...
    <p>
      Iricontes no fue capaz de tomar una decisión, y ordenó a sus soldados protegerse si la
      situación lo requería. Kokino Laudi, alto mando de la caballería de la república, mató
    ...
    <p>
      ...
      reino. Este hecho no fue del todo satisfactorio para los mismos alados, quienes aún resentían
      a Nevhea por no permitir a sus soldados defenderse a muerte, y otros hechos que le dejaron una
      mala fama.
    </p>
    <h4 id="rotten-plague">2633: Plaga Negativa</h4>
    <p>
    ...
    <p>
      ...
      de raíz con la negatividad. Su voz se esparció rápidamente por el mundo, y aunque sus métodos
      causaron duda, cualquier medida contra la plaga era apreciada. Y las medidas eran la
      compasión, el entendimiento, el perdón. Faustiely Arisa recordó al mundo que,
      independientemente de sus ramas , al final eran todos folia.
    </p>
    <p>
    ...
    <ul>
      <li>
        <p><b>Nevhea Glaen</b>, de los <span class="style-winged">alados</span>.</p>
      </li>
      <li>
        <p><b>Arqheid Keyes</b>, de los <span class="style-caudate">caudados</span>.</p>
      </li>
      <li>
        <p><b>Iricontes Pelistcia</b>, de los <span class="style-flowering">florecidos</span>.</p>
      </li>
      <li>
        <p><b>Faustiely Arisa</b>, de los <span class="style-triadia">Triadios</span>.</p>
      </li>
    </ul>
    <p>
      Faustiely Arisa, de los triaders. Poco después de la fundación de
      <span class="style-triadia">Triadia</span> , Nevhea Glaen desapareció, y desde entonces tres
      personas la han sucedido, entre ellas la actual representante de alados: Luroce Fosdia. El
      Palacio de Glaen fue ofrecido a Tani Prigemo como recuerdo de la amistad que alguna vez
      mantuvo con Nevhea, pero Tani lo rechazó, y desde entonces se ha mantenido sin dueño,
      protegido como una reliquia.
    </p>
    <p>
      Después del fallecimiento de Arqheid, siguió su hijo Delion como representante de los
      caudados, y mucho después Zollern Crésford, el actual, luego que Delion decidió renunciar al
      cargo. Los florecidos han sido representados por cuatro personas después de Iricontes, entre
      ellas Ílyosfyt Sucreuq, quien actualmente les representa. Faustiely es la única representante
      que aún no ha sido sucedida.
    </p>
  </section>
</template>

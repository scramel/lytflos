...
<template>
  <section id="section-folia">
    ...
    <p>
      ...
      demás obtienen esta usando otros métodos, por ejemplo absorbiendo restos del suelo como es el
    ...
    <article class="background-caudate">
      ...
      <p>
        <small>
          ...
          <span class="style-startrail">estela</span> altera un espacio, incluso en cadena si se
          usan varias. Cualquier <span class="style-branches">rama</span> puede activarla, pero solo
          un <span class="style-caudate">caudado</span> puede dibujarla. Existen
    ...
    <article class="background-flowering">
      ...
      <p>
        <small>
          ...
          como sólidos, líquidos, gases, o plasmas; u ondas como las gravitatorias, calóricas, o
          sonoras.
        </small>
      </p>
    </article>
    ...
    <p>
      ...
      la expresión lo que los diferencia. Por ejemplo, si un grupo de
      <span class="style-folia">folia</span> quisiera colocar agua en un hueco, un
      <span class="style-winged">alado</span> podría mover agua de otro sitio a este (haciéndolo
      fluir, levitar, dándole formas, etc.), un
      <span class="style-flowering">florecido</span> podría crearlo a partir de la nada con un
      chasquido de dedos (aunque sería temporal), y un
      <span class="style-caudate">caudado</span> podría alterar el estado físico de los alrededores
      para terraformar el sitio, sea causando lluvias, derretimientos, o aguas termales (alterando
    ...
    <p>
      <b>En síntesis:</b> <span class="style-winged">Alado</span> &gt;
      <span class="style-flowering">Florecido</span> &gt;
      <span class="style-caudate">Caudado</span> &gt; <span class="style-winged">Alado</span>.
    </p>
    <p>
    ...
    <table>
      ...
      <tbody>
        <tr class="background-winged">
          <td><span class="style-elements">Elemento Natural</span></td>
          <td>Traslación</td>
          <td>Medio ambiente</td>
          <td>Náturo</td>
        </tr>
        <tr class="background-caudate">
          <td><span class="style-dendrites">Dendrita</span></td>
          <td>Alteración</td>
          <td>Sistemas</td>
          <td>Glifos</td>
        </tr>
        <tr class="background-flowering">

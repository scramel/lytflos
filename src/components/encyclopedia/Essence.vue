...
<template>
  <section id="section-essence">
    <h1 id="essence" :name="name">{{ name }}</h1>
    <hr />
    <p>
    ...
    <p>
      La culminación de los sentimientos en los seres vivos; contiene las emociones y en cierto modo
      la personalidad del ser en el que se encuentra. Se moldea con memorias, experiencias, y
    ...
    <p>
      ...
      usuario debe influirse a sí mismo la emoción necesaria para activarlo. Activar distintos
      espírios en poco tiempo también, sumado a generar fatiga mental. El límite usual de un
    ...
    <h2 id="philosophers-stone">~ Piedra filosofal</h2>
    <p>
    ...
    <ul>
      <li>
        <p>
          <span class="style-caudate">Rubí:</span> Duplica la capacidad de
          <span class="style-startrail">estela</span> del usuario.
        </p>
      </li>
      <li>
        <p>
          <span class="style-hybrid">Amatista:</span> Duplica la resistencia del crisalismo del
          usuario.
        </p>
      </li>
      <li>

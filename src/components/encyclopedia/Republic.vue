<template>
  <section id="republic">
    ...
    <h3 id="dasoddis">~ Dasódis 🏛</h3>
    <p>
      Proveniente del griego δασώδης (dasódis, lit. “arbolado”), esta ciudad es una de las más
      ...
      planetario, e inventores de las plataformas transmutadoras. Completamente opuesto a la
      capital, aquí la ciudad se identifica por su verdor y sus hogares de aspecto más rural; casi
      todas las viviendas están cubiertas por los árboles de la zona, y algunas son parte de los
      mismos. Al inicio del año 2997 ocurrió una explosión de luz en la copa del árbol planetario
      que fue directamente visible para al menos la mitad de los habitantes del mundo. La teoría más
      popular es que se trató de una muestra de la energía contenida en los cuarzos de ánima, mas
      nadie está seguro de qué causó realmente tal fenómeno, y la mayoría desacredita la existencia
      de dichos cuarzos. Por desgracia, esta ciudad es también conocida por ser el lugar donde
      ocurrió la Masacre de Dasódis, un incidente donde decenas de pacientes del Hospital Doshi
      fueron asesinados. La naturaleza misteriosa y sangrienta del caso trajo mucha conmoción y
      llevó a las personas a cuestionar la seguridad de la república. Localizaciones de interés:
      Árbol Planetario. Bosque de Dasódis. Expreso Dendrón. Hospital Doshi. Mansión Ōrora. Té
      Retsyo: Casa de Té. Residencias.
    </p>
    ...
    <p>
      ...
      a su cercanía a la Mina Prohibida. Por su lugar en el mundo (médanos del sur) y la unicidad de
      sus vistas, es un lugar popular entre los turistas. En la superficie está Pueblo Cañón, un
      pequeño y caluroso lugar. No muchos visitan este pueblo excepto inversionistas interesados en
      exportar cerezas aparisivas a otras ciudades, y otros que están de paso para invertir en
      piedras preciosas. Existen rumores de tratos de naturaleza no muy legal: contrabando de
      espírios y objetos raros. Este lugar es constantemente vigilado por el sheriff del Subsuelo de
      Abbso. Localizaciones de interés: Estanque Turquesa. Espacio Público: Observatorio Falso.
      Expreso Dendrón. Chordyline: Sello discográfico (y venta de cerezas). Residencias. Subsuelo de
      Abbso.
    </p>
    ...
    <p>
      ...
      moldeadas por alados con el expreso motivo de crear una fortaleza prácticamente imposible de
      invadir o siquiera alcanzar por otras ramas. A pesar de que Nelfal era entonces el rey de
      Ftéryon, culturalmente se considera a la hija como quien verdaderamente tomaba las riendas
      para proteger a su gente. Poco después del fin de la Era de Conquista, tanto Nevhea como Tani
      desaparecieron y Nelfal fue derrocado de su posición por su propia gente. El palacio fue
      dejado sin dueño, y en el presente existe como una reliquia del pasado. Los habitantes de
      Ftéryon esperan la llegada de un Glaen o Prigemo para otorgarles el palacio.
    </p>

    <h3 id="peninsula-carulea">~ Península Carúlea</h3>
    <p>
      Al noreste de Dasódis se encuentra una península el cual comprende un atolón que contiene la
      pequeña isla. Una inusual cantidad de criaturas, flora, y árboles de tamaños extremos reside
      allí. Una iniciativa para plantar un segundo árbol planetario en el lugar es considerada, pero
      la poca población junto a la naturaleza salvaje de la zona retienen tal propuesta. Lo más que
      se puede encontrar en esta península son muy pequeñas villas en las zonas más alejadas de los
      animales. Es raro para turistas venir aquí, pero es un lugar muy llamativo para exploradores
      más extremos, dado que se habla de posibles ruinas, cavernas, frutas exóticas, y minerales de
      gran valor. La población es muy pequeña, y prácticamente todos se conocen entre sí debido a
      ello.
    </p>
    ...
    <p>
      ...
      habitan. Debido a la naturaleza de la ciudad, la importancia del Centro de Control Climático
      (CCC) local es mucho mayor al de la mayoría del resto de localizaciones. Ftéryon, considerada
      su gemela, también comparte esta necesidad.
    </p>

    <h3 id="pteryon-ciudad-perdida">~ Ptéryon (ciudad perdida)</h3>
    <p>
      ...
      ser restaurada debido a que las plantas que allí han crecido con los años ahora sostienen
      estructuras antiguas que de otra forma serían inestables. Una destinación muy común entre
    ...
    <p>
      ...
      finalmente comprado por los Fóster. El nombre del castillo y la ciudad fueron mantenidos en
      honor a la amistad que alguna vez mantuvieron los Keyes con los Rérecros. La arquitectura de
      la ciudadela es maximalista, única en el mundo. Se dice que la sangre de los mejores caudados
      reside en esta ciudad. Entre otras cosas, la Torre del CERT, donde se entrenan los mejores
      expiadores del mundo, se encuentra en esta ciudad. También están la sede principal de Ikaki,
      actualmente inactiva, y el Instituto de Investigación de
    ...
    <h3 id="subsuelo-de-abbso">~ Subsuelo de Abbso</h3>
    <p>
      ...
      contener criaturas sumamente peligrosas además de personas. Su principal guarda es Yoshikawa
    ...
    <h3 id="villa-lykofos">~ Villa Lykófos</h3>
    <p>
      ...
      fue inicialmente fundada por la familia Ōrora al decidir poblar el área junto a los Vagantes
      de Rérecros. Eventualmente, la familia Ōrora enfocaría su atención a la transmutación, y
      vendería sus tierras a los Faumiller, quienes dieron el nombre que posee la granja
      actualmente. Otros lugares de interés incluyen la biblioteca pública donde reside cierta
      cuentista, la ciudad perdida de la villa, el bosque de Lykófos, una herrería, y la repostería
      Light DeLight. Aquí yace el filamento que sostiene la semilla Estýlar. La villa fue
      inicialmente poblada por los Vagantes de Rérecros en su búsqueda por refugio de la guerra.
      Lykófos se convirtió en una villa de muy rica gastronomía basada en tartas, jugos, panes,
      néctares, sidra y otros productos hechos a base de fruta pasionaria. Cada último día de la
      semana, los pobladores de la villa se reúnen para celebrar su bienestar y amistad.
    </p>

...
<template>
  <section id="section-culture">
    ...
    <h3 id="studies">- Estudios</h3>
    <p>
      Se divide en 4 partes: inicial (4 años), primaria (6 años), secundaria (6 años), y terciaria
      (variable). Durante los estudios iniciales se enseñan las bases para aprender: escribir, leer,
      comunicarse, jugar, comprender, y desarrollar curiosidad junto a creatividad. No se enseñan
      conceptos mágicos en este período, en cambio se espera que el potencial de los niños como
      usuarios de estela sea evaluado.
    </p>
    <p>
      Durante la educación primaria hay un enfoque muy grande por enseñar modales, gentileza con la
      naturaleza, desarrollar habilidades sociales y de cocina, y especialmente dar enseñanzas sobre
      amistad, además de materias estándares. El estela es introducido en este período,
      particularmente a partir del cuarto año de primaria. Se espera que los estudiantes dominen sus
      talentos innatos antes de pasar a la educación secundaria. Algunos se gradúan habiendo
      aprendido un efecto.
    </p>
    <p>
      En la educación secundaria las materias obligatorias son muy pocas, sólamente comprendiendo
      literatura, matemáticas, estela, ramas, educación física, economía doméstica, y ánimo solo a
      partir del cuarto año. En cada nuevo año estudiantil los profesores realizan una introducción
      a todas las demás materias posibles de aprender, tales como geografía, astronomía, ciencias,
      criaturas, física, artes, etc., de modo que los estudiantes pueden decidir añadir a su
      currículo las materias que más les agradan. Se alienta a elegir al menos dos, y no es
      imposible elegir todas.
    </p>
    <p>
      Las clases no son obligatoriamente presenciales, sino que los estudiantes pueden decidir
      continuar su aprendizaje en sus dormitorios o incluso desde sus hogares. Cada año se evalúa
      tres veces el dominio que los estudiantes tienen sobre las materias en su currículo, de este
      modo los profesores pueden saber quiénes se están quedando atrás y darles guía. Se espera que
      los estudiantes dominen una raíz, un efecto, y una antesis antes de terminar este período,
      además de contar con los conocimientos necesarios para emprender nuevos aprendizajes y aportar
      a la sociedad utilizando sus talentos innatos. En ocasiones, alguien se gradúa habiendo
      aprendido dos raíces, especialmente alados. Es obligatorio que todos los folia obtengan hasta
      educación secundaria. Adicionalmente, es común que existan actividades extracurriculares que
      cubren intereses específicos más allá de lo enseñado normalmente, en forma de clubes. Cada
      club es dirigido por un estudiante que cumple el rol de presidente, y requiere al menos 3
      integrantes (presidente incluído) para ser oficializado. Está permitido realizar actividades
      de club fuera de la institución de ser necesario, por ejemplo si un club de ciclismo no tiene
      un espacio deportivo. Los clubes a veces evolucionan a pequeñas comunidades luego que los
      estudiantes terminan su educación secundaria.
    </p>
    <p>
      La educación terciaria son especializaciones enseñadas en universidades, y la duración del
      aprendizaje depende del currículo. Una o más raíces y efectos pueden ser aprendidos en este
      período, y la modalidad de estudios es parecida al de la educación secundaria, excepto que en
      este período todas las materias que vayan a ser enseñadas son obligatorias.
    </p>
    ...
    <p>
      El juego se originó durante la Era de Conquista, cuando los zorros gigantes eran muy comunes,
      posiblemente entre los niños como una variación del típico juego de persecución.
    </p>
    <h3 id="maximum-sentence">- Máxima sentencia</h3>
    <p>
      La mayor penalización por cometer un crimen. No suele ser el crimen en sí mismo lo que
      conlleva a la máxima sentencia, sino la falta de disposición a arrepentirse, a cambiar las
      maneras, y a enmendar los errores. La penalización en sí es el arrebatamiento del núcleo, que
      incapacita el uso de la estela, junto a una cadena perpetua en el Subsuelo de Abbso.
    </p>
    <p>
      Anteriormente, especialmente durante la tiranía de Arthe Rérecros, se le permitía dar fin a
      una vida como máxima sentencia, pero durante la fundación
    ...
    <h3 id="transmutation-platforms">- Plataformas transmutadoras</h3>
    <p>
      Un medio de transporte moderno, diseñado por Theod Ōrora, que consiste en utilizar raíces que
      conectan entre sí diversas localizaciones del mundo, de modo que para accionarlas una persona
      debe ingresar estela en un tallado que representa la ciudad destino.
    </p>
    <p>
    ...
    <p>
      Dado el calendario de <span class="style-lytflos">Lytflos</span> un folia promedio vive
      aproximadamente trescientos años. Estos pueden reproducirse tanto asexualmente (a través de
      apomixis) como sexualmente (a través de un proceso propio de ellos). De desarrollarse en el
      suelo, el folia crece absorbiendo los nutrientes en el mismo hasta que es lo suficientemente
      grande para desprenderse de sus raíces.
    </p>
    <p>
      Si un folia crece dentro de otro (solo posible a través de reproducción sexual), su desarrollo
      es similar al de un mamífero, incluyendo la producción de leche por parte del folia fecundado.
      Aunque existen folia con distintos aparatos reproductores, pueden reproducirse entre sí
      independientemente de cuáles tengan. Me niego a describir cómo funciona eso.
    </p>
    ...
    <p>
      Durante la Era de Conquista, numerosos ciudadanos de Rérecros huyeron por miedo a la guerra.

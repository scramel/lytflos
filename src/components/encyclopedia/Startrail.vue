...
<template>
  <section id="section-startrail">
    ...
    <p>
      ...
      <a href="#iris-fragments-&-golden-bubbles" class="style-iris-fragments">fragmento de iris</a>
    ...
    <article class="background-winged">
      ...
      <p>
        ...
        magma, etcétera. Normalmente los <a href="#winged" class="style-winged">alados</a> necesitan
        ayuda de un compañero <a href="#natur" class="style-natur">nátur</a> para aprender la
    ...
    <article class="background-flowering">
      ...
      <p>
        Facilidad en materializar átomos u ondas de características arbitrarias a toda velocidad. El

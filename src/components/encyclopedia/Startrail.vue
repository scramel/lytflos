...
<template>
  <section id="section-startrail">
    ...
    <article class="background-flowering">
      <h4 id="stellar-pollen">- Polen estelar</h4>
      <p>
        <small>
          Facilidad en materializar átomos u ondas de características arbitrarias a toda velocidad.
          El
          <span class="style-folia">folia</span> se puede especializar en materia, sean sólidos,
          líquidos, gases, o plasmas; o en ondas, sean gravitatorias, calóricas, o sonoras.
        </small>
      </p>
    </article>
    <h2 id="nodes">~ Nodos</h2>
    <p>
      Aplicaciones muy específicas de <span class="style-startrail">estela</span> o
    ...
    <ol>
      ...
      <li>
        <p>
          Un <span class="style-nodes">nodo</span> no está activo pasivamente excepto si se indica
          lo contrario.
        </p>
      </li>
      <li>
        <p>
          ...
          sus efectos o del usuario.
        </p>
      </li>
      <li>
        <p>
          Tras su uso, un <span class="style-nodes">nodo</span> tiene un periodo de enfriamiento
          antes de poder volver a utilizarse. Por lo general, este periodo finaliza cuando la
          historia avanza a la siguiente escena.
        </p>
      </li>
      <li>
        <p>
    ...
    <p>
      ...
      asemeja luciérnagas: las <span class="style-golden-bubbles">burbujas de oro</span>, las cuales
      sí que pueden absorber los <span class="style-folia">folia</span>. A este proceso cíclico se
      le denomina ciclo estelar.
    </p>
    ...
    <ol>
      ...
      <li>
        ...
        <p>
          <small>
            ...
            por shots y no requieren ser mantenidas, por lo que son permanentes. Los
            <span class="style-dendrites">glifos</span>, por otra parte, generalmente son
            temporales.
          </small>
        </p>
      </li>
      ...
      <li>
        <p>
          <b>Quienes mutan a otros no inmutan:</b> Es imposible usar
          <span class="style-startrail">estela</span> para alterar o trasladar un
          <span class="style-folia">folia</span> además de uno mismo, ni siquiera usando
          <span class="style-nodes">nodos</span>, <span class="style-dendrites">dendritas</span>, o
